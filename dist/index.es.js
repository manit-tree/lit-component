...
const at = (r) => new ht(typeof r == "string" ? r : r + "", void 0, et), lt = (r, t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const P = globalThis, N = P.trustedTypes, Z = N ? N.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, st = "$lit$", _ = `lit$${Math.random().toFixed(9).slice(2)}$`, it = "?" + _, At = `<${it}>`, g = document, C = () => g.createComment(""), U = (r) => r === null || typeof r != "object" && typeof r != "function", W = Array.isArray, mt = (r) => W(r) || typeof (r == null ? void 0 : r[Symbol.iterator]) == "function", z = `[ 	
\f\r]`, S = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, F = /-->/g, G = />/g, A = RegExp(`>|${z}(?:([^\\s"'>=/]+)(${z}*=${z}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Q = /'/g, X = /"/g, rt = /^(?:script|style|textarea|title)$/i, gt = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), yt = gt(1), v = Symbol.for("lit-noChange"), d = Symbol.for("lit-nothing"), Y = /* @__PURE__ */ new WeakMap(), m = g.createTreeWalker(g, 129);
function nt(r, t) {
    ...
    for (; (i = m.nextNode()) !== null && h.length < a; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const l of i.getAttributeNames()) if (l.endsWith(st)) {
          ...
          h.push({ type: 1, index: o, name: T[2], strings: u, ctor: T[1] === "." ? St : T[1] === "?" ? bt : T[1] === "@" ? Pt : R }), i.removeAttribute(l);
...
D == null || D(x, O), (P.litHtmlVersions ?? (P.litHtmlVersions = [])).push("3.2.1");
const Ct = (r, t, e) => {
...
var tt;
w._$litElement$ = !0, w.finalized = !0, (tt = globalThis.litElementHydrateSupport) == null || tt.call(globalThis, { LitElement: w });
...
var Ht = Object.defineProperty, Mt = Object.getOwnPropertyDescriptor, ot = (r, t, e, s) => {
